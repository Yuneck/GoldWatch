...
productRouter.get('/products', async (req : any, res : any) => {
    try {
...
productRouter.get("/product/:id", async (req : any, res : any) => {
    try {
...
productRouter.put("/product/:id", async (req : any, res : any) => {
    try {
...
productRouter.delete("/product/:id", async (req : any, res : any) => {
    try {
